...
# Calculates the total speed from the speed of each individual mecanumwheel speed
...
# # Using IP connection
# while True:
#         # Change host to ip address of UW wifi
#         host=getip()
#         print(host)
#         port=6677
#         points=[]
...
#                         points=pickle.loads(data)
#                         print('starting print 4 seconds')
#                         sleep(4)
#                         # Plan the robot's movement
#                         for i, path in enumerate(points):
#                                 for j in range(len(path)-1):
#                                         # Pen Down
#                                         moveTo(path[j], path[j+1])
#                                         #print('next coord')
#                                 # Pen Up
#                                 if i < len(points)-1 and points[i][-1]
# != points[i+1][0]:
